;SECTION "Bank 7 - Variable width font", ROMX[$4310],BANK[$07]

SECTION "Bank 7 - Font", ROMX[$4710],BANK[$07]
DB $ff, $18, $fb, $1c, $ff, $7e, $d8, $3f, $fb, $1c, $f3, $0c, $ff, $7e, $c0, $3f
DB $ff, $00, $ff, $7c, $c6, $3f, $fe, $7f, $c6, $ff, $de, $e7, $fe, $7f, $c0, $3f
DB $ff, $c0, $df, $e0, $ff, $fc, $c7, $fe, $de, $e7, $de, $e7, $fc, $ff, $81, $7e
DB $ff, $00, $ff, $00, $ff, $7c, $c7, $fe, $dc, $e3, $df, $e6, $fc, $7f, $c1, $3e
...
DB $ff, $00, $ff, $00, $ff, $c6, $fe, $ff, $b8, $7f, $ff, $fe, $c6, $ff, $9c, $63
DB $ff, $00, $ff, $00, $fe, $c7, $de, $e7, $de, $e7, $fe, $7f, $c6, $3f, $fc, $7f
DB $ff, $00, $ff, $00, $ff, $fe, $8e, $7f, $fc, $7f, $e1, $fe, $ff, $fe, $80, $7f
